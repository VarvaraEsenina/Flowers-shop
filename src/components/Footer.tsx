    ...
    return (
        <>
            <footer className="d-flex flex-row bg-dark text-light p-2 gap-3 align-items-start user-select-none justify-content-between ">
                ...
                <div>
                    <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A420b0d4ff0f7022b99b8fd3b103cfbf7a417d20aa690d9302e07a796cef7dab4&amp;source=constructor" width="500px" height="400px"></iframe>
                </div>
